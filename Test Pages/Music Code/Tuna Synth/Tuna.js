...
let keyboardPosition = 4,
  ...
  reverb = new Tone.JCReverb(0.2).connect(Tone.Master),
...
function chorusEffectToggle() {
  ...
  chorusPower.style.color = effectsAddedList.includes("chorus")
    ? "#bd3578"
    : "#9ca0b1";
}
...
function tremoloEffectToggle() {
  ...
  tremoloPower.style.color = effectsAddedList.includes("tremolo")
    ? "#bd3578"
    : "#9ca0b1";
}
...
function vibratoEffectToggle() {
  ...
  vibratoPower.style.color = effectsAddedList.includes("vibrato")
    ? "#bd3578"
    : "#9ca0b1";
}
...
function phaserEffectToggle() {
  ...
  phaserPower.style.color = effectsAddedList.includes("phaser")
    ? "#bd3578"
    : "#9ca0b1";
}
...
function reverbEffectToggle() {
  ...
  reverbPower.style.color = effectsAddedList.includes("reverb")
    ? "#bd3578"
    : "#9ca0b1";
}
...
function distortionEffectToggle() {
  ...
  distortionPower.style.color = effectsAddedList.includes("distortion")
    ? "#bd3578"
    : "#9ca0b1";
}
...
function bitCrusherEffectToggle() {
  ...
  bitCrusherPower.style.color = effectsAddedList.includes("bitCrusher")
    ? "#bd3578"
    : "#9ca0b1";
}
